            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-[#271043]/30 backdrop-blur-sm border border-white/10 rounded-3xl p-12 flex flex-col items-center justify-center text-center space-y-6">
                    ...
                    <p className="text-gray-400 max-w-md mx-auto">
                        Halaman ini akan segera diperbarui dengan daftar sponsor dan media partner yang mendukung terselenggaranya Pradipta 2026. Terima kasih atas dukungan luar biasa yang diberikan.
                    </p>
                </div>
            </div>
        </section>
